...
var princess = ["arial", "cinderella", "snow white", "pocahontos", "belle", "jasmine", "rapanzul", "tiana", "mulan", "merida"];
...
var numLosses = 0;
var getNewWord;
var wordPlace; //place in princess array
var correctGuesses;
var wordAsArr = [];
var dashesArray = [];
...
function initialize() {
	...
	currentWord = princess[wordPlace];			//string
